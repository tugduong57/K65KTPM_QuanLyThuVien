...
def quanlykhosach(root):
    ...
    def xoa_sach() : 
        ma_sach = entry_ID.get()
        connectSQL.delete_sach(ma_sach)
    ...
    buttonXoa = Button(Root, image=ig_Xoa, borderwidth=0, highlightthickness=0, command = xoa_sach); buttonXoa.place(x=635, y=490 )
